  ...
  return (
    <div className="my-9 flex gap-10 justify-center">
      ...
      <div className="flex-1">
        ...
        <hr />
        <p className="text-[#131313CC] my-3 text-sm">
          <b className="text-lg">Review</b> : {review}{" "}
        </p>

        <div className="flex mt-5 gap-7">
          <span className="font-bold text-lg text-black">Tag :</span>
          <div className="flex gap-3">
            <h1 className=" py-1 bg-[#F3F3F3] text-[#23BE0A] text-sm px-4 font-bold rounded-xl">
              #{tags[0]}
            </h1>
            <h1 className=" py-1 bg-[#F3F3F3] text-[#23BE0A] text-sm px-4 font-bold rounded-xl">
              #{tags[1]}
        ...
        <div className="flex gap-3 mt-6 font-bold">
          <button
            ...
            className="border text-[#131313] p-5"
          >
            Read
          </button>
          <button
            onClick={() => handleAddToWishList(bookId)}
            className="border text-white bg-[#50B1C9] p-5"
          >
            Wishlist
          </button>
        </div>
